# Generated by Django 5.0.3 on 2024-05-23 16:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(choices=[('English', 'English'), ('Russian', 'Russian'), ('Turkmen', 'Turkmen')], default='English', max_length=100)),
                ('level', models.CharField(choices=[('Başlangyç', 'Başlangyç'), ('Orta', 'Orta'), ('Ýokary dereje', 'Ýokary dereje')], default='Başlangyç', max_length=100)),
                ('platform_status', models.CharField(choices=[('Review', 'Review'), ('Draft', 'Draft'), ('Disabled', 'Disabled'), ('Published', 'Published'), ('Rejected', 'Rejected')], default='Published', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('New Order', 'New Order'), ('New Review', 'New Review'), ('New Course Question', 'New Course Question'), ('Course Published', 'Course Published'), ('Draft', 'Draft')], max_length=100)),
